...
Датасет находится по ссылке: https://bit.ly/3D0Q68N
...
Их спектры флуоресценции находятся по ссылке: https://bit.ly/307L5Nx
...
Данные по ссылке: https://bit.ly/31M8zIp
...
Данные доступны по ссылке: https://bit.ly/3H7d68s
